    ...
    <div className="bg-white" style={{ paddingTop: "80px" }}>
      ...
      <section className="position-relative py-5">
        ...
        <div className="container position-relative z-1 py-5 my-5">
          <h1
            className="display-4 fw-bold text-custom-teal shadow-sm bg-white bg-opacity-75 p-4 rounded-4 d-inline-block"
        ...
        <div className="row g-4 align-items-stretch">
          ...
          <div className="col-12 col-md-7">
            <div className="bg-custom-teal bg-opacity-10 h-100 rounded-4 p-5 d-flex flex-column justify-content-center shadow-sm">
              ...
              >
                Danbury Bright Smiles was built starting inside out for
                uninsured people. That is why we offer our own in-house
                membership - a simple and affordable alternative to traditional
                insurance, providing you with clear pricing and peace of mind.
                Whether you're uninsured or want a better way to manage your
                dental care, our membership plan provides a stress-free option.
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        id="membership-plan"
        className="py-5 text-center container mt-4"
        style={{ scrollMarginTop: "100px" }}
      >
        <h2
          className="display-4 fw-bold text-custom-teal mb-2"
          style={{ letterSpacing: "2px" }}
        >
          Membership Plan
        </h2>
        <p className="text-custom-teal lead fw-bold mb-4">
          Affordable Care, Anytime You Need It
        </p>
        <p
          className="text-secondary mb-5 small mx-auto"
          style={{ maxWidth: "600px" }}
        >
          Explore our special dental membership plans — created to keep your
          smile healthy with affordable, consistent pricing and exceptional
          benefits.
        </p>
        ...
        <div className="row g-4 justify-content-center">
          ...
          <div className="col-12 col-md-5">
            <div className="bg-custom-teal bg-opacity-25 rounded-4 p-5 text-center shadow-sm h-100 border border-white border-5">
              ...
              <ul className="list-unstyled text-secondary small lh-lg mb-5">
                ...
                <li className="mt-2 text-dark" style={{ fontSize: "11px" }}>
                  Any additional treatments needed
                  <br />
                  excluding sedation
                </li>
              </ul>
              <button className="btn btn-dark text-white rounded-pill px-5 py-2 shadow fw-bold mt-auto w-75">
                Book Now
              </button>
            </div>
          </div>
          ...
          <div className="col-12 col-md-5">
            <div className="bg-custom-teal bg-opacity-25 rounded-4 p-5 text-center shadow-sm h-100 border border-white border-5">
              <h3 className="h4 text-dark fw-bold">Minor</h3>
              ...
              <p className="small text-dark fw-bold mb-4">$229 / Year</p>
              <h5 className="fw-bold text-dark fs-6 mb-3">Included Services</h5>
              <ul className="list-unstyled text-secondary small lh-lg mb-5">
                <li>2 Cleanings</li>
                <li>Exams</li>
      ...
      <section
        id="insurances"
        className="py-5 container text-center mt-5"
        style={{ scrollMarginTop: "100px" }}
      >
        <h2
          className="display-5 fw-bold text-custom-teal mb-5"
          style={{ letterSpacing: "2px" }}
        >
      ...
      <section
        id="payment-options"
        className="py-5 container text-center mt-4 mb-5"
        style={{ scrollMarginTop: "100px" }}
      >
        <h2
          className="display-5 fw-bold text-custom-teal mb-5"
        ...
        <div className="row g-4 justify-content-center">
          <div className="col-12 col-md-6">
            <div className="bg-custom-teal bg-opacity-25 rounded-4 p-5 text-start h-100 shadow-sm border border-white border-5">
              <h4 className="text-dark fw-bold mb-4 fs-5 lh-base">
              ...
              >
                At Danbury Bright Smiles, we believe quality dental care should
                be accessible to everyone. That is why we offer CareCredit, a
                convenient financing option that allows you to pay for
                treatments over time with flexible, monthly payments.
              </p>
              <ul
                className="small text-secondary mb-5 ps-3"
                style={{ lineHeight: "1.8" }}
              >
                <li className="mb-2">
                  <span className="fw-bold text-dark">Instant Approval</span> -
                  Apply online and get a decision in minutes.
                </li>
                <li className="mb-2">
                  <span className="fw-bold text-dark">Pay over time</span> - Get
                  the treatment today and pay over time.
                </li>
                <li>
                  <span className="fw-bold text-dark">
                    Special Financing Options
                  </span>{" "}
                  - Enjoy interest free plans when paid in full within the
                  promotional period.
                </li>
              </ul>
          ...
          <div className="col-12 col-md-6">
            <div className="bg-custom-teal bg-opacity-25 rounded-4 p-5 text-start h-100 shadow-sm border border-white border-5">
              ...
              <p
                ...
                style={{ lineHeight: "1.8" }}
              >
                At Danbury Bright Smiles, we believe everyone deserves a
                confident, healthy smile without financial stress. That is why
                we've partnered with Cherry, a simple and fast payment plan
                option that lets you split your treatment costs into monthly
                payments.
              </p>

              <p className="small text-dark fw-bold mb-2">Why Choose Cherry?</p>
              <ul
                className="small text-secondary mb-5 ps-3"
                style={{ lineHeight: "1.8" }}
              >
      ...
      {/* Map Section */}
      <section
        className="position-relative w-100 border-top border-4 border-custom-teal"
      ...
      >
        ...
        ></iframe>
        <div
          className="position-absolute bottom-0 start-0 m-2 m-md-5 p-4 bg-white bg-opacity-75 rounded-4 shadow"
          style={{ backdropFilter: "blur(10px)", minWidth: "350px" }}
        >
          <div className="d-flex align-items-center gap-2 fw-bold text-dark mb-4">
            <div
              className="bg-custom-teal text-white rounded d-flex align-items-center justify-content-center"
